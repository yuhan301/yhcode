...
"#frame{border: 2px solid rgba(100,100,100,100);}"));
        ...
        btn_savePassword = new QPushButton(frame);
        btn_savePassword->setObjectName("btn_savePassword");
        btn_savePassword->setGeometry(QRect(220, 110, 61, 21));
    ...
    void retranslateUi(QWidget *FrmLogIn)
    {
        ...
        btn_savePassword->setText(QCoreApplication::translate("FrmLogIn", "\344\277\235\345\255\230\345\257\206\347\240\201\357\274\237", nullptr));
    } // retranslateUi
